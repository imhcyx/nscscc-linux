...
#define dma_map_single(dev,ptr,size,dir) plat_map_dma_mem(dev,ptr,size)
#define dma_unmap_single(dev,ptr,size,dir) plat_unmap_dma_mem(dev,ptr,size,dir)
#endif
...
void * plat_alloc_consistent_dmaable_memory(struct device *, u32, dma_addr_t *);
...
static u32 __inline__ synopGMACReadReg(u32 *RegBase, u32 RegOffset)
{
  ...
  void *addr = (void *)RegBase + RegOffset;
