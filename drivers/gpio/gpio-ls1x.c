 ...
 * GPIO_BANK_COUNT,
 * struct gpio_bank gpio_bank_ls1x,
 *
 */
...
{
	u32 reg = bank->pbase+GPIO_REG_DIR;
	if(__raw_readl(reg) & offset)  /*ls1x gpio: 0 is output; 1 is input*/
		return GPIO_INPUT;
	else 
		return GPIO_OUTPUT;
}
